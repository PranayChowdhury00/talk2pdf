      ...
      >
        ...
        <div className="flex-1 overflow-y-auto mt-4">
          ...
          <img
            ...
            src="https://i.ibb.co/TDRR5vZM/d.jpg"
            alt="Vercel logomark"
          />
          <h1 className="text-xl text-center pt-4 text-violet-500">
            Sign in for free to save your chat history
          </h1>
          <div className="text-center pt-4">
            <button className="rounded-lg bg-violet-500 px-8 py-3 text-xl text-white duration-300 active:scale-95">
              Sign UP
            </button>
          </div>
        </div>
