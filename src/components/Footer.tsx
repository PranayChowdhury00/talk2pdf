    ...
    return (
        <footer className="py-10 px-6 border-t border-border">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
                    ...
                    <div className="mb-6 md:mb-0 text-center md:text-left">
                        ...
                        <p className="mt-2 max-w-md text-muted-foreground">
                            AI-powered PDF chat and summarization. Easily
                ...
                {/* Footer Links */}
                <div className="border-t border-border mt-6 pt-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
                    {/* Features */}
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            {["Contact Us", "Help Center", "API Docs"].map(
                                (item, index) => (
                                    <li key={index}>
                                        <a
                                            href="#"
                ...
                <div className="border-t border-border mt-6 pt-4 text-center text-muted-foreground text-sm">
                    &copy; {new Date().getFullYear()} Talk2PDF. All rights
                    reserved.
                </div>
            </div>
        </footer>
